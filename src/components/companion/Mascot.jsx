  ...
  return (
    ...
    >
      <svg viewBox="0 0 130 185" width="100%" height="100%">
        ...
        <ellipse cx="65" cy="172" rx="34" ry="9" fill="url(#hydriShadowGradient)" />

        <g ref={leftLegRef}>
          <line x1="56" y1="130" x2="48" y2="160" stroke="url(#hydriDenimGradient)" strokeWidth="9" strokeLinecap="round" />
          <ellipse cx="48" cy="158" rx="7" ry="4" fill="#7d97b8" />
          <ellipse cx="48" cy="164" rx="9" ry="5.5" fill="url(#hydriShoeGradient)" stroke="#a02f28" strokeWidth="1.2" />
        </g>
        <g ref={rightLegRef}>
          <line x1="76" y1="130" x2="84" y2="160" stroke="url(#hydriDenimGradient)" strokeWidth="9" strokeLinecap="round" />
          <ellipse cx="84" cy="158" rx="7" ry="4" fill="#7d97b8" />
          <ellipse cx="84" cy="164" rx="9" ry="5.5" fill="url(#hydriShoeGradient)" stroke="#a02f28" strokeWidth="1.2" />
        </g>

        <g ref={bodyRef}>
          {/* long hair, drawn behind the head and shoulders */}
          <ellipse cx="65" cy="40" rx="34" ry="36" fill="url(#hydriHairGradient)" />
          <path
            d="M 38 42 C 20 60, 16 100, 24 150 C 30 156, 40 152, 36 142 C 30 105, 34 68, 46 46 Z"
            fill="url(#hydriHairSideGradient)"
            filter="url(#hydriDropShadow)"
          />
          <path
          ...
          <rect x="50" y="66" width="7" height="14" fill="url(#hydriDenimGradient)" stroke="#2a4258" strokeWidth="1.5" />
          <rect x="73" y="66" width="7" height="14" fill="url(#hydriDenimGradient)" stroke="#2a4258" strokeWidth="1.5" />
          <rect x="57" y="98" width="16" height="13" rx="2" fill="none" stroke="#2a4258" strokeWidth="1.5" />

          {/* head */}
          <circle cx="65" cy="52" r="23" fill="url(#hydriSkinGradient)" />
          {/* soft cheek sheen */}
          ...
          {pose === 'annoyed' ? (
            ...
            <>
              ...
              <circle cx="57" cy="55" r="5.2" fill="url(#hydriIrisGradient)" />
              <circle cx="73" cy="55" r="5.2" fill="url(#hydriIrisGradient)" />
          ...
          {/* rose hair clip */}
          <g transform="translate(84, 30)" filter="url(#hydriDropShadow)">
            <circle cx="0" cy="0" r="4.5" fill="url(#hydriRoseGradient)" />
            <circle cx="4" cy="-2" r="4" fill="url(#hydriRoseGradient)" />
            <circle cx="-3" cy="-3" r="3.5" fill="url(#hydriRoseGradient)" />
        ...
        <g ref={leftArmRef}>
          <line x1="46" y1="84" x2="28" y2="112" stroke="url(#hydriCollarGradient)" strokeWidth="7" strokeLinecap="round" />
          <circle cx="28" cy="112" r="5" fill="url(#hydriSkinGradient)" />
          {/* rose held in hand */}
          <g filter="url(#hydriDropShadow)">
            ...
            <circle cx="16" cy="114" r="4.5" fill="url(#hydriRoseGradient)" />
            <circle cx="19" cy="111" r="4" fill="url(#hydriRoseGradient)" />
            <circle cx="12" cy="112" r="3.8" fill="url(#hydriRoseGradient)" />
            <circle cx="16" cy="109" r="3.4" fill="#f0a0a0" opacity="0.8" />
          </g>
        </g>
        <g ref={rightArmRef}>
          <line x1="84" y1="84" x2="102" y2="112" stroke="url(#hydriCollarGradient)" strokeWidth="7" strokeLinecap="round" />
          <circle cx="102" cy="112" r="5" fill="url(#hydriSkinGradient)" />
        </g>
      </svg>
